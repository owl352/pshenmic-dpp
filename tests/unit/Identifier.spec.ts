...
describe('Identifier', function () {
  ...
  describe('serialization / deserialization', function () {
    ...
    test('should allows to create Identifier from base64', function () {
      const identifier = IdentifierWASM.fromBase64('CSgo7cCB07oaVPBDJZuUE2jyxxiIGwap00eIOyG/4xM=')

      expect(identifier.bytes()).toEqual(identifierBytes)
    })

    test('should allows to create Identifier from hex', function () {
      const identifier = IdentifierWASM.fromHex('092828edc081d3ba1a54f043259b941368f2c718881b06a9d347883b21bfe313')
    ...
    test('should allows to create Identifier from base58 in constructor', function () {
      const identifier = new IdentifierWASM('ckBqfQe7LU7vwrwXopyCB4n5phZShjA16BGhNGpsD5U')
  ...
  describe('getters', function () {
    test('should allow to get identifier base58', function () {
      ...
      expect(identifier.base58()).toEqual('ckBqfQe7LU7vwrwXopyCB4n5phZShjA16BGhNGpsD5U')
    })

    test('should allow to get identifier base64', function () {
      const identifier = IdentifierWASM.fromBase58('ckBqfQe7LU7vwrwXopyCB4n5phZShjA16BGhNGpsD5U')

      expect(identifier.base64()).toEqual('CSgo7cCB07oaVPBDJZuUE2jyxxiIGwap00eIOyG/4xM=')
    })

    test('should allow to get identifier hex', function () {
      const identifier = IdentifierWASM.fromBase58('ckBqfQe7LU7vwrwXopyCB4n5phZShjA16BGhNGpsD5U')

      expect(identifier.hex()).toEqual('092828edc081d3ba1a54f043259b941368f2c718881b06a9d347883b21bfe313')
    })
