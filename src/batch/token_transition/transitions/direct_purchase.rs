...
impl TokenDirectPurchaseTransitionNAPI {
    ...
    pub fn new(
        ...
        token_count: BigIntString,
        total_agreed_price: BigIntString,
    ...
    pub fn get_token_count(&self) -> BigIntString {
        BigIntString::from_u64(self.0.token_count())
    }

    #[napi(getter, js_name = "totalAgreedPrice")]
    pub fn get_total_agreed_price(&self) -> BigIntString {
        BigIntString::from_u64(self.0.total_agreed_price())
    }
    ...
    pub fn set_token_count(&mut self, token_count: BigIntString) -> Result<(), napi::Error> {
