...
export class TokenDestroyFrozenFundsTransitionWASM {
    ...
    constructor(base, frozenIdentityId, publicNote) {
        this._rawTransition = new dppProvider.dpp.TokenDestroyFrozenFundsTransitionNAPI(base._rawTokenBaseTransition, prepareIdentifierValue(frozenIdentityId), publicNote);
    }
    get base() {
    ...
    static createFromRawInstance(rawInstance) {
        const instance = Object.create(TokenDestroyFrozenFundsTransitionWASM.prototype);
