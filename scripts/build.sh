...
RUSTFLAGS="-C link-arg=--initial-memory=1310720 -C link-arg=--max-memory=2490368 -C target-feature=+crt-static -C embed-bitcode=no -C metadata=reduced -C link-dead-code=no -C panic=abort"
