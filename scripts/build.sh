...
RUSTFLAGS="-C link-arg=--initial-memory=1179648 -C link-arg=--max-memory=5767168 -C target-feature=+crt-static -C embed-bitcode=no -C metadata=reduced -C link-dead-code=no -C panic=abort"
