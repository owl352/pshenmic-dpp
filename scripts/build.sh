...
RUSTFLAGS="-C link-arg=--initial-memory=1048576 -C link-arg=--max-memory=5777216 -C target-feature=+crt-static -C embed-bitcode=no -C metadata=reduced -C link-dead-code=no -C panic=abort"
