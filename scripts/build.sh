...
RUSTFLAGS="-C target-feature=+atomics -С target-feature=--enable-threads -C target-feature=+crt-static -C embed-bitcode=no -C metadata=reduced -C link-dead-code=no -C panic=abort"
