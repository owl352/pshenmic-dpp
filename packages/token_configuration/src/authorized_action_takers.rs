...
impl AuthorizedActionTakersWASM {
    ...
    pub fn taker_type(&self) -> String {
        match self.0 {
            ...
            AuthorizedActionTakers::Identity(identifier) => format!("Identity({})", encode(identifier.as_slice(), Base58)),
    ...
    pub fn get_value(&self) -> JsValue {
        match self.0 {
            ...
            AuthorizedActionTakers::Identity(identifier) => JsValue::from(IdentifierWASM::from(identifier)),
