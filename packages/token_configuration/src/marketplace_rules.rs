...
use crate::trade_mode::TokenTradeModeWASM;
...
impl TokenMarketplaceRulesWASM {
    ...
    pub fn set_trade_mode_change_rules(&mut self, trade_mode_change_rules: &ChangeControlRulesWASM) {
        self.0.set_trade_mode_change_rules(trade_mode_change_rules.clone().into());
    }
}
